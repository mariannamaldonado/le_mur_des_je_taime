...
//color groups
.water{background:#C5EFF7;}
.water{background:transparent;}
.north-america{background:#90C695;}
.south-america{background:#E26A6A;}
.europe{background:#BE90D4;background:#E26A6A;}
.africa{background:#FDE3A7;}
.asia{background:#F4B350;}
.australia{background:#1E824C;}


.north-america, .africa, .asia, .australia{background:rgba(#171441, 0.8);} 

//minimal color group
.minimal{
    .water{background:transparent;}
    .north-america, .south-america, .europe, .africa, .asia, .australia{background:#ccc;} 
}
