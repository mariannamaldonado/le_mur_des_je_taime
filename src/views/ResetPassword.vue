    ...
    <div id="box" class="col col-12 col-lg-4 offset-lg-4 p-5 bg-white rounded">
      ...
      <div class="form-floating mb-3">
        ...
        <label for="floatingInput"
          ><i class="fas fa-envelope-open-text"></i>&nbsp;Password</label
        >
      </div>
      <div class="form-floating mb-3">
        <input
        ...
        />
        <label for="floatingInput"
          ><i class="fas fa-envelope-open-text"></i>&nbsp;Repeat Password</label
        >
      </div>
  ...
  setup() {
    ...
    async function updatePassword() {
      let { data } = await axios.post(
        `http://localhost:8081/api/users/resetpassword`,
        {
